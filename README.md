...
┌─────────────────────┐
│   原始 Excel/XLS    │  ← data/raw/
│      数据文件        │
└──────────┬──────────┘
           │
           ▼ Extract: 使用 pandas/openpyxl 读取
┌─────────────────────┐
│   原始数据 DataFrame  │  ← 多源数据
└──────────┬──────────┘
           │
...
│  ├── ageing_ratio_per_region.csv         │
│  ├── uk_population_projection_all.csv    │
│  ├── england_clean.csv                   │
│  ├── scotland_clean.csv                  │
│  ├── wales_clean.csv                     │
│  └── ageing_cluster_input.csv            │
└──────────┬───────────────────────────────┘
           │
           ▼ 下游使用
┌────────────────────────────────────────┐
